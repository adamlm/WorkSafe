...
public class Main_Screen_Admin extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list = (ListView)findViewById(R.id.existingIssuesList2);
        CreateListView();

        settings = (Button)findViewById(R.id.Settings_Button_Admin);
        settings.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Code here executes on main thread after user presses button
                Intent goToSettings = new Intent(Main_Screen_Admin.this, Settings.class);
        ...
        newIssue.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Code here executes on main thread after user presses button
                Intent goToSettings = new Intent(Main_Screen_Admin.this, Submit_New_Issue.class);
                startActivity(goToSettings);
            }
        });
        */
